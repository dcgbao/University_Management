...
import Page_Devices_Door from "./pages/Page_Devices_Door/Page_Devices_Door";
      ...
      <BrowserRouter>
        <Routes>
          <Route path="/" element={<MainLayout />}>
            ...
            />
            <Route path="/devices/bulb" element={<Page_Devices_Bulb />} />
            <Route path="/devices/door" element={<Page_Devices_Door />} />
            <Route path="/devices/pumper" element={<Page_Devices_Pumper />} />
